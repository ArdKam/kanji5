const CACHE='kanji5-shell-v35';
const DATA_CACHE='kanji5-data-v22';
const API_CACHE='kanji5-api-v12';
const SHELL=["./","./index.html","./manifest.webmanifest","./icon.svg","./v1.3-p0.js","./v1.3-perf.js","./v1.3-storage-bridge.js","./v1.3-settings.js","./v1.4-education-core.js","./v1.4-education-ui.js","./vendor/ts-fsrs-5.4.1.mjs","./v1.2-enhancements.js","./v1.2-runtime-fixes.js","./supabase-config.js","./supabase-sync.js"];
