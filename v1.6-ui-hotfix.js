...
function attachPanelObserver(panel){if(panelObserver)panelObserver.disconnect();refresh();panelObserver=new MutationObserver(()=>refresh());panelObserver.observe(panel,{childList:true,subtree:true,characterData:true,attributes:true,attributeFilter:['disabled','class']})}
