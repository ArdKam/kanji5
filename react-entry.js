(()=>{
'use strict';
if('serviceWorker' in navigator)navigator.serviceWorker.register('./sw.js?v=142').catch(()=>{});
...
if(!reactStylesheet){
  ...
  reactStylesheet.href='./react-dist/kanji5-react.css?v=20260925-release3';
  reactStylesheet.dataset.kanji5React='true';
  document.head.appendChild(reactStylesheet);
}
import('./react-dist/kanji5-react.js?v=20260925-release3')
