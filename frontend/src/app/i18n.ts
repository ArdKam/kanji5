...
const messages: Record<Language, Record<TranslationKey, string>> = {
  fa: {
    ...
    upcomingReviews:"مرورهای پیش‌رو", settingsTitle:"تنظیمات", newKanjiPerDay:"کانجی جدید در روز", dailyReviewGoal:"هدف تعداد مرور روزانه", fsrsRetention:"میزان نگهداشت FSRS",
  ...
  en: {
    ...
    upcomingReviews:"Upcoming reviews", settingsTitle:"Settings", newKanjiPerDay:"New kanji per day", dailyReviewGoal:"Daily review goal", fsrsRetention:"FSRS retention",
