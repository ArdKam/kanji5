...
const messages: Record<Language, Record<TranslationKey, string>> = {
  ...
  en: {
    ...
    correctRecall:"Recall was correct.", correctAnswer:"Correct answer", dictionary:"Kanji dictionary", dictionaryTitle:"Kanji dictionary", dictionaryPlaceholder:"Search kanji, reading, or meaning", dictionaryHint:"Search by the kanji itself, a reading, or an English meaning.", dictionarySearching:"Searching…", dictionaryNoResults:"No results found.", dictionaryStrokes:"Strokes", dictionaryGrade:"Grade", dictionaryJlpt:"JLPT", dictionaryFrequency:"Frequency", dictionaryOn:"On’yomi", dictionaryKun:"Kun’yomi", dictionaryMastery:"Mastery", dictionaryCardTitle:"Kanji card", dictionaryLoading:"Loading kanji…", dictionaryGrid:"Kanji catalog", dictionaryLevel:"JLPT level", allLevels:"All", dictionarySort:"Sort", sortLevelAsc:"Level: N5 → N1", sortLevelDesc:"Level: N1 → N5", sortMasteryDesc:"Mastery: high → low", sortMasteryAsc:"Mastery: low → high", sortOriginal:"Original order", masteryOverview:"Mastery overview", masterySignal:"Mastery signal", modelConfidence:"Model confidence", sevenDayActivity:"7-day review activity", reviewsCount:"reviews", cardPage:"Card information page", previousCardPage:"Previous card information page", nextCardPage:"Next card information page", swipeForMore:"Swipe for more information"
  }
};
