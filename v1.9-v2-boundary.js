...
async function revealLearning(){const bridge=window.__KANJI5_V19_REVIEW_BRIDGE__;const ok=Boolean(bridge?.reveal?.());if(ok)setTimeout(()=>{void refreshLearning()},0);return ok}
