...
if(!sw.includes('"./v1.5-p0.js"')){
  sw=sw.replace('"./v1.4-education-ui.js",','"./v1.4-education-ui.js","./v1.5-p0.js",');
  fs.writeFileSync(swPath,sw);
}
console.log('Applied v1.5 P0: JLPT-gated new-card order and P0 interaction runtime.');
