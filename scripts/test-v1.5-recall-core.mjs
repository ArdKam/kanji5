...
const correct = recordRecallOutcome(original, 'meaning', 'study', 'correct', '2026-09-04T00:00:00.000Z');
...
const unknown = recordRecallOutcome(original, 'meaning', 'study', 'unknown', '2026-09-04T00:00:01.000Z');
