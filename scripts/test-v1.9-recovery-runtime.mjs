...
assert.match(ui,/v19RetryBtn/);assert.match(ui,/v1\.9-feedback/);assert.match(ui,/__KANJI5_EDU_BRIDGE__/);assert.doesNotMatch(ui,/document\.getElementById\('v14EduNext'\)\?\.click\(\)/);
