...
assert(migration.includes("import('./v1.5-education-ui.js')")||boundary.includes("await import('./v1.5-education-ui.js')"),'Education runtime boundary must hand active education UI to v1.5');
