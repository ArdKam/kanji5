...
class FakeElement{
  constructor(tag='div'){this.tagName=tag.toUpperCase();this.id='';this.hidden=false;this.parentNode=null;this.children=[];this.dataset={};this.classList={toggle(){} ,contains:()=>false};this.style={};this.value='';this.innerHTML='';this.textContent='';this._listeners={};}
...
assert(state.mode==='production'&&state.item.character==='学','Production mode did not start with the selected Kanji');
