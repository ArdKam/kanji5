...
assert(targetChoice.matches('.v14-edu-choice'),'Fake choice does not match MCQ selector');
assert(listeners.click?.length===2,`Expected two document click handlers, got ${listeners.click?.length||0}`);
