...
const app=read('frontend/src/app/App.tsx');assert.match(app,/PracticeHandwriting/);assert.match(app,/getHandwritingSkill/);assert.match(app,/recordHandwritingGrade/);assert.doesNotMatch(app,/Handwriting.*rateLearning|recordHandwritingGrade[\\s\\S]{0,300}rateLearning/);console.log('Kanji 5 Practice handwriting integration boundary passed.');
