...
assert.match(index,/v1\.5-education-ui\.js/);assert.match(read('v1.5-education-ui.js'),/waitForDeck/);assert.match(index,/v1\.9-learner-model\.js/);assert.match(index,/v2-presentation\.js/);
