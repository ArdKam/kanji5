...
assert(!prod.includes('باید کانجی را بنویس'),'Production MCQ runtime still asks the user to type Kanji');
assert(!prod.includes('کانجی را بنویس'),'Production MCQ runtime still contains a typing prompt');
