...
assert(p0.includes("submit=wrap.querySelector('#v14EduSubmit')")&&p0.includes("submit.style.display='none'"),'Production text-submit control remains visible after MCQ conversion');
