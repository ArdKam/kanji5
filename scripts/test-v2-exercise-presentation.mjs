...
for(const cls of ['v2-exercise-card','v2-mode-badge','v2-stimulus','v2-kanji','v2-feedback-card','v2-insights','v2LearningCard','v2AnswerInput','v2Submit']) assert.ok(js.includes(cls),cls);
