...
assert(s.includes("const CACHE='kanji5-shell-v64'"),'Shell cache missing or stale');assert(s.includes("const DATA_CACHE='kanji5-data-v24'"),'Data cache missing');assert(s.includes("const API_CACHE='kanji5-api-v14'"),'API cache missing');
