...
const sw=fs.readFileSync('sw.js','utf8');assert.match(sw,/v1\.9-v2-contract-core\.js/);assert.match(sw,/v1\.9-v2-boundary\.js/);assert.match(sw,/kanji5-shell-[A-Za-z0-9._-]+/);
