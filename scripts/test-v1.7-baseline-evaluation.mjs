...
const history=[
  {sessionId:'a1',evaluationStrategy:'adaptive',evaluationSchemaVersion:1,modeResults:{meaning:{attempts:4,correct:3},reading:{attempts:2,correct:1}},endedAt:'2026-09-01T10:00:00Z'},
  {sessionId:'a2',evaluationStrategy:'adaptive',evaluationSchemaVersion:1,modeResults:{meaning:{attempts:2,correct:2},reading:{attempts:2,correct:1}},endedAt:'2026-09-02T10:00:00Z'},
  {sessionId:'b1',evaluationStrategy:'baseline',evaluationSchemaVersion:1,modeResults:{meaning:{attempts:4,correct:2},reading:{attempts:2,correct:1}},endedAt:'2026-09-01T11:00:00Z'},
