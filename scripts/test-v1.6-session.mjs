...
for(const id of ['v16Session','v16Due','v16New','v16Mastered','v16Streak','v16GoalBar','v16Reviews','v16Recall','v16Unknown','v16Duration','v16Modes','v16Attention'])assert.match(session,new RegExp(`id=\\"${id}\\"`),`session dashboard node missing: ${id}`);
