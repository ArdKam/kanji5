...
if(/\\.learning-card\\[data-card-density=dense\\] \\.learning-back-overview\\{[^}]*grid-template-columns:minmax\\(0,1fr\\) minmax\\(0,1fr\\)/.test(reactCss)) throw new Error("SHIPPED_REACT_CSS_CONTAINS_DENSE_TWO_COLUMN_BACK_LAYOUT");
if(!/\.learning-card-back \\.learning-back-overview/.test(reactCss)||!/\.learning-card-back \\.learning-back-tools/.test(reactCss)) throw new Error("SHIPPED_REACT_CSS_MISSING_ONE_COLUMN_BACK_LAYOUT_GUARD");
