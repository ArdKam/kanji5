...
assert.match(index, /rel="stylesheet" href="\.\/react-dist\/kanji5-react\.css\?v=(?:__KANJI5_RELEASE__|[A-Za-z0-9._-]+)"[^>]*data-kanji5-react-styles/, "React CSS should use the release stamp or a stamped build value");
