...
The app fetches the per-character SVG assets from the KanjiVG repository and displays the stroke paths in their documented stroke order. The viewer does not modify the underlying KanjiVG data.
