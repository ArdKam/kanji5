...
test('builds, persists, and exposes learner model evidence',async({page})=>{
  ...
  await page.evaluate(()=>{
    ...
    localStorage.setItem('kanji5-v1.5-components',JSON.stringify({v19LearnerEvidence:{学:[
      {at:'2026-09-12T00:00:00.000Z',mode:'reading',outcome:'wrong'},
      {at:'2026-09-13T00:00:00.000Z',mode:'reading',outcome:'correct'},
      {at:'2026-09-14T00:00:00.000Z',mode:'reading',outcome:'wrong'},
      {at:'2026-09-15T00:00:00.000Z',mode:'reading',outcome:'correct'}
    ]}}));
  });
